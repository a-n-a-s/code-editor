              ...
              openFiles.length > 0 ? (<div className="h-full flex flex-col" >
                  ...
                  <Tabs value={activeFileId || ""} onValueChange={setActiveFileId}>
                    <div className="flex items-center justify-between px-4 py-2 ">
                      <TabsList className="h-8 bg-transparent p-0" >
                        {
                          openFiles.map((file) => (
                            <TabsTrigger key={file.id} value={file.id} className="relative h-8 px-2  data-[state=active]:bg-background data-[state=active]:shadow-sm group">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className="ml-2 h-4 w-4 hover:bg-destructive-foreground rounded-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all  cursor-pointer" onClick={(e) => {
                                  e.stopPropagation();
                                  closeFile(file.id)
                                }} >
                                  <X className="w-3 h-3" />
                ...
                <div className="flex flex-col h-full items-center justify-center text-muted-foreground gap-4">
                  ...
                  <div className="text-center">
                    <p className="txet-lg font-medium" >No Files Open</p>
