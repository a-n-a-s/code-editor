        ...
        <>
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <Button size={"sm"} variant={isEnabled ? "destructive" : "outline"} className={cn("relative gap-2 h-8 px-3 test-sm font-medium transition-all duration-200",
                        isEnabled ? "bg-zinc-900 hover:bg-zinc-800 text-zinc-50 dark:bg-zinc-800 dark:hover:bg-zinc-900"
                            : "bg-background hvoer:bg-accent border-border text-foreground",
                ...
                <DropdownMenuContent align="end" className="w-72">
                    <DropdownMenuLabel className="flex items-center justify-between py-2">
                        ...
                        <Badge className={cn("text-xs", isEnabled ? "bg-zinc-900 text-zinc-50 border-zinc-800 dark:bg-zinc-50 dark:text-zinc-900 dark:border-zinc-700" : "bg-muted text-muted-foreground")}  >
                    ...
                    <DropdownMenuItem onClick={() => onToggle(!isEnabled)} className="py-2.5 cursor-pointer" >
                        <div className="flex items-center justify-between w-full">
                            ...
                            <div className={cn(
                                ...
                                isEnabled ? "bg-zinc-900 border-zinc-900 dark:bg-zinc-50 dark:border-zinc-50"
                                    : "bg-muted border-border")} >
                                <div className={cn("w-3 h-3 rounded-full bg-background duration-200 transition-all absolute top-0.5", isEnabled ? "left-4" : "left-0.5")} />
